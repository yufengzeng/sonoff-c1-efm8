...
extern void TIMER01_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TL0 (Timer 0 Low Byte) = 0xD7
	*/
	TL0 = (0xD7 << TL0_TL0__SHIFT);
	// [TL0 - Timer 0 Low Byte]$
...
extern void TIMER16_2_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// TMR2H (Timer 2 High Byte) = 0x40
	*/
	TMR2H = (0x40 << TMR2H_TMR2H__SHIFT);
	// [TMR2H - Timer 2 High Byte]$

	// $[TMR2L - Timer 2 Low Byte]
	/*
	// TMR2L (Timer 2 Low Byte) = 0x98
	*/
	TMR2L = (0x98 << TMR2L_TMR2L__SHIFT);
	// [TMR2L - Timer 2 Low Byte]$

	// $[TMR2RLH - Timer 2 Reload High Byte]
	/*
	// TMR2RLH (Timer 2 Reload High Byte) = 0x40
	*/
	TMR2RLH = (0x40 << TMR2RLH_TMR2RLH__SHIFT);
	// [TMR2RLH - Timer 2 Reload High Byte]$

	// $[TMR2RLL - Timer 2 Reload Low Byte]
	/*
	// TMR2RLL (Timer 2 Reload Low Byte) = 0x98
	*/
	TMR2RLL = (0x98 << TMR2RLL_TMR2RLL__SHIFT);
	// [TMR2RLL - Timer 2 Reload Low Byte]$
...
extern void PCACH_0_enter_DefaultMode_from_RESET(void) {
	...
	/*
	// CAPN (Channel 0 Capture Negative Function Enable) = ENABLED (Enable
	...
	//     function.)
	*/
	PCA0CPM0 = PCA0CPM0_CAPN__ENABLED | PCA0CPM0_ECCF__ENABLED | PCA0CPM0_MAT__DISABLED
...
extern void INTERRUPT_0_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	//     interrupt set to low priority level.)
	// PMAT (Port Match Interrupt Priority Control) = LOW (Port Match
	//     interrupt set to low priority level.)
	// PPCA0 (Programmable Counter Array (PCA0) Interrupt Priority Control) =
	//     HIGH (PCA0 interrupt set to high priority level.)
	// PSMB0 (SMBus (SMB0) Interrupt Priority Control) = LOW (SMB0 interrupt
	...
	*/
	EIP1 = EIP1_PADC0__LOW | EIP1_PWADC0__LOW | EIP1_PCP0__LOW | EIP1_PCP1__LOW
		 | EIP1_PMAT__LOW | EIP1_PPCA0__HIGH | EIP1_PSMB0__LOW | EIP1_PT3__LOW;
	// [EIP1 - Extended Interrupt Priority 1]$
...
extern void TIMER16_3_enter_DefaultMode_from_RESET(void) {
	...
	*/
	...
	/*
	// TMR3L (Timer 3 Low Byte) = 0x0B
	*/
	TMR3L = (0x0B << TMR3L_TMR3L__SHIFT);
	// [TMR3L - Timer 3 Low Byte]$

	// $[TMR3RLH - Timer 3 Reload High Byte]
	/*
	// TMR3RLH (Timer 3 Reload High Byte) = 0xB0
	*/
	...
	/*
	// TMR3RLL (Timer 3 Reload Low Byte) = 0x3F
	*/
